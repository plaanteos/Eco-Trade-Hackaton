...
import { MapPin, Calendar, Clock, Package, Shield, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="mb-12 text-center">
          <div className="inline-block border-4 border-[#2D5016] bg-white px-12 py-6 transform rotate-1 shadow-lg">
            ...
            <div className="text-lg text-[#2D5016] uppercase tracking-wider" style={{ fontFamily: 'var(--font-serif)' }}>
              EN SOLANA
            </div>
          </div>
        </div>
        ...
        {session.verifiedBy && (
          <div className="bg-white border-2 border-[#1A1A1A] p-6 mb-8">
            ...
            <div className="font-medium">{session.verifiedBy}</div>
          </div>
        )}

        {/* Privacy notice */}
        <div className="bg-[#FFF4E6] border-l-4 border-[#B85C00] p-6">
          <h3 className="text-sm uppercase tracking-wider font-bold mb-3">
            Privacidad
          </h3>
